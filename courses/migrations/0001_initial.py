# Generated by Django 2.2.4 on 2019-12-12 07:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answers', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='content_type', to='courses.Module')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', courses.fields.OrderField(blank=True)),
                ('content_type', models.ForeignKey(limit_choices_to={'model_in': ('text', 'video', 'image', 'file', 'quiz')}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
                ('answers', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contents', to='courses.Module')),
            ],
            options={
                'ordering': ['order'],
            },
